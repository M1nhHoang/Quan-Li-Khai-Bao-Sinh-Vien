package com.quanlikhaibaoo.test_support;

import com.quanlikhaibaoo.QuanLiKhaiBaoMainApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.quanlikhaibaoo.screen")
@ContextConfiguration(classes = {QuanLiKhaiBaoMainApplication.class, UiTestAssistConfiguration.class})
